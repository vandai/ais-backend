...
Get all published events with pagination, filtering, and search capabilities.
...
| `per_page` | integer | No | 10 | Number of items per page (1-100) |
| `page` | integer | No | 1 | Page number |
| `category_id` | integer | No | - | Filter by event category ID |
| `keyword` | string | No | - | Search in title, description, and location |

**Request:**
```http
GET /api/events?per_page=10&page=1&category_id=1&keyword=nobar HTTP/1.1
Host: localhost:8000
Accept: application/json
```
  ...
  "data": [
    {
      ...
      "description": "Yuk nonton bareng pertandingan seru Arsenal melawan Manchester United...",
      "slug": "nobar-arsenal-vs-manchester-united",
      "image": "event-image.jpg",
      "image_url": "http://localhost:8000/storage/events/event-image.jpg",
      "location": "Warung Kopi Arsenal, Jakarta Selatan",
      "fee": "50000.00",
      "start_datetime": "2026-01-13T20:00:00.000000Z",
      "end_datetime": "2026-01-13T23:00:00.000000Z",
      "member_only": false,
      "status": "published",
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `event_id` | integer | Yes | Event ID (positive integer) |
...
### 21. List Event Categories

Get all event categories with their published event count.
...
**Request:**
```http
GET /api/event-categories HTTP/1.1
Host: localhost:8000
Accept: application/json
```
...
### 29. Get All Competition Standings
...
### 30. Get Arsenal Season Statistics
